...
# -- Project information -----------------------------------------------------
from adspackage import __version__
project = 'adspackage'
copyright = '2022, Aaron Schroeder'
...
# If sphinx_autosummary_accessors is included
# import sphinx_autosummary_accessors
# templates_path.append(sphinx_autosummary_accessors.templates_path)
